...
/**
 * Action handling changes in the audio rate.
 * 
...
public class SamplingRateAction extends AbstractAction {
	...
	/**
	 * references to the radio buttons representing the range of possible audio
	 * rates.
	 */
	...
	/**
	 * Returns the audio rate as an double representing samples per second.
