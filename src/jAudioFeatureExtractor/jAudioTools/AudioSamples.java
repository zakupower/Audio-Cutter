 ...
 * AudioInputStreams, audio files or existing arrays of audio values.
 *
 ...
 * Methods are also available for checking if any audio values fall out of the
...
public class AudioSamples 
{
	 ...
	 * corresponds to channel and second indice corresponds to audio number.
	 */
	 ...
	 *									absolute value of the highest amplitude audio is
	 *									1. Does this if and only if one or more of the samples
	 *									is outside the allowable range of audio values
	 *									(-1 to 1). If set to false, then does not
	 *									normalize, regardless of audio values.
	 ...
	 *									corresponds to the audio number.
	 ...
	 * seconds of the recording and the maximum audio amplitude.
	 *
	...
	/**
	 * Returns the stored audio samples between the given audio indices.
	 ...
	 * single channel.
	 *
	 * @param	start_sample	The audio indice of the first audio to return.
	 *                          Must be 0 or higher and must be less than
	 *                          end_sample.
	 * @param	end_sample		The audio indice of the last audio to return.
	...
	{
		if (start_sample < 0)
			throw new Exception( "Requested audio starting at audio " + start_sample +
			                     "\nStart audio indice must be 0 or greater." );
		if (end_sample >= samples.length)
			throw new Exception( "Requested audio ending at audio " + end_sample +
			                     "\nA total of " + samples.length + "samples are present." +
			                     "\nRequested ending audio indice must be less than this." );
		if (start_sample >= end_sample)
			throw new Exception( "Requested audio starting at audio " + start_sample +
			                     " and ending at audio " + end_sample + ".\n" +
			                     "Requested start audio indice must be less than requested" +
			                     "\nend audio indice." );
	 ...
	 * single channel.
	 *
	 * @param	start_time		The time, in seconds, of the first audio to
	 *                          return. Must be 0 or higher and must be less than
	 *                          end_time.
	 * @param	end_time		The time, in seconds, of the last audio to return.
	 ...
	 *							and the second indice specifies the audio index
	 *							within the window.
	 ...
	 *          to the channel and the second indice corresponds to the audio
	 *          number.
	 */
	 ...
	 *							and the second indice corresponds to the audio
	 *					        number.
	 * @throws	Exception		Throws an informative exception if the given
	 *							start audio or end audio are outside acceptable
	 *                          ranges.
	 ...
	 * @param	normalize_if_clipped	If set to true, then normalizes audio so the
	 *									absolute value of the highest amplitude audio is 1.
	 *									Does this if and only if one or more of the samples to
	 *									save is outside the allowable range of audio values
	 *									(-1 to 1). If set to false, then does not
	 *									normalize, regardless of audio values. <b>WARNING:</b>
	...
	/**
	 * Returns the maximum deviation in the stored mixed down audio values outside
	 * the permissible range of -1 to +1. Returns -1.0 if all samples fall withing
	 * the permissible range.
	 *
	 * @return	The maximum deviation from the permissible audio values. -1 if
	 *			all audio values fall within the allowable range.
	 */
	...
	/**
	 * Returns the maximum deviation in the stored audio values outside the
	 ...
	 * of the highest audio amplitude is 1. Does nothing if all samples are 0.
	 */
	 ...
	 * down into one channel so that the absolute value of the highest audio
	...
	/** 
	 * Returns the given audio index converted into a time in seconds based
	 * on the sampling rate of the stored audio samples. If the given audio
	 * index is negative, then time 0 is returned. If the given audio index
	 * is greate thean the length of the audio, then the time of the last index
	 * is returned.
	 *
	 * @param	sample_index	The audio index to convert to a time value.
	 * @return					The time in seconds corresponding to the given
	 *							audio index, or the nearest time if the
	 *							given audio index is outside the duration
	 *							of the audio.
	 */
	...
	/** 
	 * Returns the given time in seconds converted into a audio index based
	 * on the sampling rate of the stored audio samples. If the given time
	 * would correspond to a negative audio, then the index of the first
	 * audio is returned. If the given time would correspond to a audio
	 * greater than the length of the audio, then the last index is returned.
	 *
	 * @param	time	The time in seconds to convert to a audio.
	 * @return			The audio corresponding to the given time, or the
	 *					nearest audio if the given time is outside the duration
	 *                  of the audio.
	 */
