...
public class DSPMethods 
{
	 ...
	 * audio amplitude is 1. Does nothing if also samples are 0.
	 *
	 ...
	 * value of the highest audio amplitude is 1. Does nothing if all
	 * samples are 0.
	 *
	 * @param	samples_to_normalize	The samples to normalize. The first indice
	 *									denotes channel and the second denotes audio
	 *									number.
	 * @return							Returns a copy of the given samples
	 *									after normalization.
	 */
	...
	/**
	 * Returns the audio corresponding to the given time with the given
	 * sampling rate.
	 *
	 * @param	time			The time in seconds to convert to a audio indice.
	 * @param	sampling_rate	The sampling rate of the audio in question.
	 * @return					The corresponding audio indice.
	 */
	...
	/**
	 * Returns the time corresponding to the given audio indice with the given
	 * sampling rate.
	 *
	 * @param	sample			The audio indice to convert to time.
	 * @param	sampling_rate	The sampling rate of the audio in question.
