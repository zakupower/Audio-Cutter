...
/**
 * Returns the audio kurtosis (aka excess) of a data sequence.
 *
 ...
 * @param size the number of elements of the data sequence.
 * @param moment4 the fourth central moment, which is <tt>moment(data,4,mean)</tt>.
 * @param sampleVariance the <b>audio variance</b>.
 */
...
/**
 * Return the standard error of the audio kurtosis.
 *
 * Ref: R.R. Sokal, F.J. Rohlf, Biometry: the principles and practice of statistics
 * in biological research (W.H. Freeman and Company, New York, 1998, 3rd edition)
 * p. 138.
...
/**
 * Returns the audio skew of a data sequence.
 *
 * Ref: R.R. Sokal, F.J. Rohlf, Biometry: the principles and practice of statistics
 * in biological research (W.H. Freeman and Company, New York, 1998, 3rd edition)
 * p. 114-115.
...
/**
 * Return the standard error of the audio skew.
 *
 * Ref: R.R. Sokal, F.J. Rohlf, Biometry: the principles and practice of statistics
 * in biological research (W.H. Freeman and Company, New York, 1998, 3rd edition)
 * p. 138.
...
/**
 * Returns the audio standard deviation.
 *
 * Ref: R.R. Sokal, F.J. Rohlf, Biometry: the principles and practice of statistics
 * in biological research (W.H. Freeman and Company, New York, 1998, 3rd edition)
 * p. 53.
...
/**
 * Returns the audio variance of a data sequence.
...
/**
 * Returns the audio weighted variance of a data sequence.
